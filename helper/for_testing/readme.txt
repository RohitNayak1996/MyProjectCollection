...
2. Installing the helper Package

A. Change to the directory that contains the file setup.py and the subdirectory helper. 
...
3. Using the helper Package

The helper package is on your Python path. To import it into a Python script or session, 
execute:
